...
const hoverScript = `
    <script>
        ...
        buttons.forEach(btn => {
            btn.addEventListener("mouseover", () => btn.style.backgroundColor = rgb(9, 16, 213));
            btn.addEventListener("mouseout", () => btn.style.backgroundColor = rgb(9, 16, 213));
        });
    </script>
`;
